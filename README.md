...
| `rest.token_bundle(mint)` | **New 1.20** · All | Bundle-cohort holdings — `bundle` summary with `held_pct_of_supply` (headline), `bundle_kind`, `fully_exited`. BASIC/TRADER=summary only, PRO=+top-10 wallet flags, ULTRA=+identity |
