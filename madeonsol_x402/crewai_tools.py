...
class MadeOnSolWalletBatchClassify(BaseTool):
    name: str = "MadeOnSol Wallet Batch Classify"
    description: str = (
...
class MadeOnSolTokenTrades(BaseTool):
    name: str = "MadeOnSol Token Trades"
    description: str = (
...
class MadeOnSolTokenDepth(BaseTool):
    name: str = "MadeOnSol Token Depth"
    description: str = (
...
class MadeOnSolTokenLocks(BaseTool):
    name: str = "MadeOnSol Token Locks"
    description: str = (
...
class MadeOnSolTokenLocksFeed(BaseTool):
    name: str = "MadeOnSol Token Locks Feed"
    description: str = (
...
class MadeOnSolTokenUnlocks(BaseTool):
    name: str = "MadeOnSol Token Unlocks"
    description: str = (
...
class MadeOnSolTokenFeeShares(BaseTool):
    name: str = "MadeOnSol Token Fee Shares"
    description: str = (
...
class MadeOnSolTokenFeeClaims(BaseTool):
    name: str = "MadeOnSol Token Fee Claims"
    description: str = (
...
class MadeOnSolTokenSurges(BaseTool):
    name: str = "MadeOnSol Token Surges"
    description: str = (
